...
//		}
	...
	//Added by me.
	public void startPerlinShake(int shakeType)
	{
		StopAllCoroutines ();

		switch (shakeType)
		{
		case 1: //Position shake.
			StartCoroutine (ShakePosition (transform, originalPos, duration, speed, magnitude, damper));			break;
		case 2:	//Rotation shake.
			StartCoroutine (ShakeRotation (transform, originalRot, duration, speed, magnitude, damper));
			break;
		case 3:	//Projection shake.
			StartCoroutine (ShakeCameraProjection (Camera.main, duration, speed, magnitude, damper));
			break;
		}			
